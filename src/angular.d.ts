...
export declare var angular: IAngularStatic;
...
///////////////////////////////////////////////////////////////////////////////
    ...
    export interface IAngularStatic {
         ...
         */
        bootstrap(element: string|Element|JQuery|Document, modules?: (string|Function|any[])[], config?: IAngularBootstrapConfig): IInjectorService;
        ...
        identity<T>(arg?: T): T;
        injector(modules?: any[], strictDi?: boolean): IInjectorService;
         ...
         */
        resumeBootstrap?(extraModules?: string[]):IInjectorService;
    }
     ...
     */
    export interface IRepeatScope extends IScope {
    ...
    export interface ILogProvider extends IServiceProvider {
    ...
    ///////////////////////////////////////////////////////////////////////////
    export interface IDocumentService extends IAugmentedJQuery {}
...
export interface ITranscludeFunction {
    ...
    export interface IControllerProvider extends IServiceProvider {
     ...
     */
    export interface IRequestShortcutConfig extends IHttpProviderDefaults {
        /**
    ...
    export interface IHttpPromise<T> extends IPromise<IHttpPromiseCallbackArg<T>> {
    ...
    ///////////////////////////////////////////////////////////////////////////
    export interface ISCEProvider extends IServiceProvider {
    ...
    ///////////////////////////////////////////////////////////////////////////
    export interface ISCEDelegateProvider extends IServiceProvider {
